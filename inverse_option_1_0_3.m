...
for i=1:length(dateset)
    i
    [~,~,~]=mkdir(strcat("Inverse_option/1_0_3/",dateset(i)));
    ...
    ylim([iv_min*0.9,iv_max*1.1])
        saveas(gcf,strcat("Inverse_option/1_0_3/",dateset(i),"/discrepancy_between_iv_ivbs.png"))
    ...
    legend('monthly call','monthly put','weekly call','weekly put', ...
        'long-maturity call','long-maturity put','45 degree')
    subplot(1,2,2)
    ...
    saveas(gcf,strcat("Inverse_option/1_0_3/",dateset(i),"/pricing_inverse_option.png"))
